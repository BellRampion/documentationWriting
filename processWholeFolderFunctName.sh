...
progOutput="names.txt"
progOutput2="decls.txt"
finalOutput="functNames.txt"
finalOutput2="functDecls.txt"
...
for filename in /mnt/c/Users/SSIntern/Documents/base/WebCalendarPicker/*.xojo_code; do
    java FunctionNameFinder "$filename"
    ./appendFile "$progOutput" "$finalOutput"
    ./appendFile "$progOutput2" "$finalOutput2"
done
